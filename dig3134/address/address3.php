...
<?php
// Simple Address Book Application Example - Level 4
//	DIG 3134 - Fall 2013 - Moshell
	...
	function  showlist($mysqli,$last='')
    {
		...
		{	$output="<table border=1><tr><th></th><th>Last Name</th><th>First Name</th><th>Address</th></tr>";
			...
			$radio="<input type='radio' name='delsel' value=$personid>";
				...
				$output.= "<tr><td align='center'>$radio</td>			<td>$lastname</td><td>
	...
	function drawinputs()
	{
		print "<input type='text' name='firstname'>First Name <br />
				...
				Select the radio button of the person to be deleted. <br />
...
// Now interact with the user
    ...
    print "<h2>Simple Address Book Example 4</h2>";
