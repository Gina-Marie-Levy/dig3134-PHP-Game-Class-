...
/////////////
	$target1= rand(1,14);
	$_SESSION['target1']=$target1; // so we will have it later also for the cards
	
	$target2= rand(1,14);
	$_SESSION['target2']=$target2; // so we will have it later lso for the cards
...
else if ($nextaction=="GUESS") 	
{
	...
	{ 			
		...
		print "Enter your next guess (1-14)<br />"; 			
		print "<input type='text' name='guessvalue'><br />"; 		
}
