...
<background=IMG SRC=\"background.gif\" ALIGN=\"CENTER\" ALT=\"background\">
<BODY bgColor="lightblue" link="navy" vlink="navy" alink="navy">
<DIV ALIGN="center">
endHTML;
...
if (!$done)
{
  ...
  if ($wrong >= $max)
  {
    ...
    print "<p><BR><FONT color=\"red\"><BIG>SORRY, YOU ARE HANGED!!!</BIG></FONT><BR><BR>";
    if (strstr($word, " ")) $term="phrase"; else $term="word";
    print "The $term was \"<B>$word</B>\"<BR><BR>\n";
...
<p align="center"><BR><BR><font face="Verdana" size="1">Thank you for playing PHP Hangman Game - Brought to you by Gina Levy<br>
</font>
